...
| `PRD.html` | 产品需求文档 v3.0 · 产品中心版（定位/问题/画像/**产品形态=常驻桌面助手**/三能力=看得见·懂业务·能裂变/技术/功能/MVP/Demo/指标/风险/演进） | 开发依据，与路演 PPT 主轴一致 |
| `路演PPT.html` | 路演演讲稿 · 8 页 · 深蓝暖金风（封面海报 + 痛点 + 产品亮相 + 三能力 + 现场 Demo + 收尾） | 浏览器按 `P` 进投影一屏一页，`←→` 翻页 |
| `产品命名.html` | 产品命名定稿（小哒 / Coda · 竞品参照 / 候选方案 / 形象设定） | 名字 + 形象一并拍板，含 icon |
| `assets/coda-icon.png` | 产品吉祥物「小哒 / Coda」3D icon（米色底，App 图标 + 路演主视觉） | 暖橙双眼萌精灵，替你把活看到收尾 |
| `assets/coda-icon-transparent.png` | 同款 icon 透明底版（叠任意背景 / 做桌宠动画母版） | 洪水填充抠图，边缘干净 |
